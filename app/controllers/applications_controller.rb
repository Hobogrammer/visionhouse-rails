class ApplicationsController < ApplicationController
  before_action :load_subject, only: [:new,:create]
  ...
  def show
    @application = Application.includes(:children,:family_members,:criminal_arrests,:employments,:housing_histories,:people).find(params[:id])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @application.save
        format.html { redirect_to new_application_family_member_path(@application) }
